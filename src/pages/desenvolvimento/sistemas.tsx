      ...
      <div id="head-dev">
        <div className="center-page">
          <div className="text">
            ...
            <p>
              Tire seu projeto do papel e alcance seu potencial máximo online!
              Entre em contato para saber mais e impulsione seu negócio para o
              sucesso digital!
            </p>
            <ContainerButtons />
          </div>
            ...
            <ul>
              <li>
                ...
                <div>
                  ...
                  <a>
                    O sistema sob medida é a melhor opção para funções e
                    ferramentas com utilidade ,resolução de problemas e uma nova
                    ideia de mercado.
                  </a>
                </div>
              </li>
              ...
              <li>
                ...
                <div>
                  ...
                  <a>
                    A alocação de SQUAD é a melhor opção quando você já tem um
                    escopo do projeto e precisa apenas da mão de obra, você quem
                    fica responsavel de gerenciar sua equipe e oque será
                    desenvolvido.
                  </a>
                </div>
              </li>
