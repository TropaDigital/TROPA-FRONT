          ...
          <div className="container-line">
            ...
            <div className="steps animate__animated animate__fadeIn">
              ...
              <MethodologyItem
                ...
                steps={["UX/UI", "Protótipos", "Testes com usuários"]}
              />
              <MethodologyItem
                top={60}
                number={3}
                ...
                steps={["Testes", "Deploy", "Dailys", "Plannings"]}
              />
              <MethodologyItem
                top={95}
                number={4}
      ...
      <section id="wedo">
        <div className="center">
          ...
          <div className="text">
            ...
            <p>
              A Tropa Digital é uma empresa líder em soluções digitais,
              especializada no desenvolvimento de sistemas web sob medida que
              atendam às necessidades exclusivas de cada cliente. Com uma equipe
              altamente qualificada e experiente, trabalhamos em estreita
              colaboração com nossos clientes para criar soluções personalizadas
              que se integram perfeitamente aos seus processos de negócios.
              Nosso objetivo é oferecer as melhores soluções digitais para
              nossos clientes, ajudando-os a levar seus negócios para o próximo
              nível. Entre em contato conosco hoje mesmo para saber mais sobre
              nossos serviços de desenvolvimento de sistemas web sob medida.
            </p>
          </div>
        ...
        <div className="center">
          ...
          <div className="item">
            ...
            <div className="text">
              ...
              <p className="description-item">no desenvolvimento</p>
            </div>
          </div>
          <div className="item">
            <div className="icon">
          ...
          <div className="item">
            ...
            <div className="text">
              ...
              <p className="description-item">e alta perfomance</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="center">
          ...
          <div className="options">
            <nav>
              <button
                className={
                  preview === "/images/cases/123jus.png" ? "active" : "normal"
                }
                onClick={() => setPreview("/images/cases/123jus.png")}
              >
                <Image
                  alt="123Jus"
                  width={162.75}
                  height={50}
                  src="/images/logo/123jus.png"
                />
              </button>
              <button
                className={
                  preview === "/images/cases/eyouomni.png" ? "active" : "normal"
                }
                onClick={() => setPreview("/images/cases/eyouomni.png")}
              >
                <Image
                  alt="eyouomni"
                  width={259.43}
                  height={50}
                  src="/images/logo/eyouomni.png"
                />
              </button>
              <button
                className={
                  preview === "/images/cases/text2you.png" ? "active" : "normal"
                }
                onClick={() => setPreview("/images/cases/text2you.png")}
              >
                <Image
                  alt="text2you"
                  width={75.21}
                  height={50}
                  src="/images/logo/text2you.png"
                />
              </button>
            </nav>
