    ...
    return (
        ...
        >
            ...
            <path
                ...
                fill="#CC6237"
            />
            <path d="M121.68 82H86.8V84H121.68V82Z" fill="#CC6237" />
        </svg>
    );
};
    ...
    return (
        ...
        >
            ...
            <defs>
                ...
                >
                    <use
                        xlinkHref="#image0_27_7"
                        transform="scale(0.03125 0.0243902)"
                    />
                </pattern>
                <image
                    id="image0_27_7"
...
export const IconChatbot: React.FC = ({
    width = 100,
    height = 10,
}: any) => {
    return (
...
export const IconCash: React.FC = ({
    width = 100,
    height = 100, 
}: any) => {
    return (
        ...
        >
            ...
            <path className="st0" d="M60.33,109.11c-26.9,0-48.78-21.88-48.78-48.78s21.88-48.78,48.78-48.78c26.9,0,48.78,21.88,48.78,48.78    S87.23,109.11,60.33,109.11z M60.33,14.2C34.9,14.2,14.2,34.9,14.2,60.33c0,25.44,20.69,46.13,46.13,46.13    s46.13-20.69,46.13-46.13C106.46,34.9,85.77,14.2,60.33,14.2z" fill="#CC6237"/>
            <path className="st0" d="M71.27,80.34H41.56v-2.65h29.71c4.22,0,7.65-3.43,7.65-7.65c0-4.22-3.43-7.65-7.65-7.65h-20    c-6.08,0-11.03-4.95-11.03-11.03c0-6.08,4.95-11.03,11.03-11.03h28.97v2.65H51.26c-4.62,0-8.38,3.76-8.38,8.38    s3.76,8.38,8.38,8.38h20c5.68,0,10.29,4.62,10.29,10.29C81.56,75.72,76.94,80.34,71.27,80.34z" fill="#CC6237"/>
            <rect x="56.12" y="30.48" className="st0" width="2.65" height="59.71" fill="#CC6237"/>
            <rect x="64.11" y="30.48" className="st0" width="2.65" height="59.71" fill="#CC6237"/>
        </svg>
    )
}
...
export const IconMessage: React.FC = ({
    ...
    return (
        <svg 
            ...
            height="50" 
        >
            <path className="st0" d="M11.98,41.74l40.91,25.78l25.65,41.3l30.14-96.96L11.98,41.74z M18.04,42.54l84.75-26.19L53.65,64.97  L18.04,42.54z M77.77,102.72L55.45,66.78l48.36-47.84L77.77,102.72z" fill="#CC6237"/>
        </svg>
    )
}
